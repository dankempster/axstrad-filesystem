...
namespace Axstrad\Bundle\HttpFileUploadBundle\Tests\Functional\app;
...
class AppKernel extends AbstractAxstradKernel
{
    ...
    public function registerBundles()
    {
        $bundles = array(
            ...
            new \Axstrad\Bundle\HttpFileUploadBundle\Tests\Functional\AxstradTestHttpFileUploadBundle(),
        );
